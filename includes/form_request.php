<?php	
	if (empty($_POST['name2_5780']) && strlen($_POST['name2_5780']) == 0 || empty($_POST['tel2_5780']) && strlen($_POST['tel2_5780']) == 0 || empty($_POST['email2_5780']) && strlen($_POST['email2_5780']) == 0)
	{
		return false;
	}
	
	$name2_5780 = $_POST['name2_5780'];
	$tel2_5780 = $_POST['tel2_5780'];
